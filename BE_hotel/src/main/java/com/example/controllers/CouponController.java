// ========================================
// CONTROLLER MÃ GIẢM GIÁ (Coupon Controller)
// ========================================
// Xử lý các endpoint liên quan đến:
// - Lấy danh sách mã giảm (/coupons)
// - Kiểm tra mã hợp lệ (/coupons/validate)
// - Quản lý mã (add, update, delete) - chỉ admin
// - Công khai cho tất cả user (GET)
